          ...
          <motion.div variants={fadeInUp} className="md:col-span-8 space-y-6">
              ...
              <div className="prose max-w-none dark:prose-invert">
                <div className="flex flex-col text-gray-800 dark:text-gray-200 text-justify">
                  ...
                  <p>
                    ...
                    have a strong passion for software development and I am
                    always excited to learn new knowledge and technologies. To
                    me, learning is a journey, not a destination. I am always
                    seeking opportunities to improve my skills and build
                    something amazing.
                    <br />
                    As of now, I am focusing on building small projects to
                    improve my skills and knowledge. Also, I will be taking
                    challenges in AI by applying to Master of Artificial
                    Intelligence at a university in Vietnam.
                  </p>
                  <p>
                    I understand the challenge of learning technical skills,
                    especially when it comes to building real-world projects.
                  ...
                  <ul className="list-none">
                    ...
                    <li>
                      <span className="emoji">👉</span> Love challenges and
                      embark on new projects
                    </li>
                  </ul>
                  <p>
                    Therefore, that would be great if we connected on social
                    media, especially on Github, kept in touch, and shared how
                    we live this life.
                  </p>
            ...
            >
              ...
              <p className="mb-4 text-gray-800 dark:text-gray-200">
                I&apos;m always excited to connect and collaborate on
